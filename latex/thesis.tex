...
\begin{abstract}
% To hide sensitive personal information in PDF documents, text is often redacted using black boxes or blurring. In many instances human error or hidden information leave traces of the original text, compromising the confidentiality. While effort is made to fix this security, for example by over-redacting text, 
...
\input{latex/sections/1-thesis/1-related-work}
